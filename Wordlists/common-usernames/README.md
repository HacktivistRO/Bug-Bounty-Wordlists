# Wordlist for Common Usernames fuzzing

This folder contains a compilation of common usernames for password spraying and user enumeration attacks.
...
### The script will merge all the part files into a single file named usernames-wordlist.txt in the script's directory.
